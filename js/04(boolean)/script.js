...

{
    ...
    toBuy ? result = (sum / rate).toFixed(2) : result = (sum * rate).toFixed(2);
    alert(result);
}//Currency exchange
...

{
    ...
    if (yourOoption === result) {
        alert("нічия");
    } else if ((yourOoption === "камінь" && result === "ножиці")
        || (yourOoption === "ножиці" && result === "папір")
        || (yourOoption === "папір" && result === "камінь")) {
        alert("Ти переміг");
    } else {
        alert("Ти програв");
    }
