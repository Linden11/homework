...

{
    ...
    body.children[0].children[0].children[0].parent = body.children[0].children[0];

    body.children[1].children[0].children[0].parent = body.children[1].children[0];
    body.children[1].children[1].children[0].parent = body.children[1].children[1];
